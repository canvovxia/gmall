package com.ketai.pms.controller;
...
public class AttrGroupController {
    ...
    public Resp<AttGroupVO>queryGroupWithAttrByGid(@PathVariable("gid")Long gid){
        AttGroupVO attGroupVOList = this.attrGroupService.queryGroupWithAttrByGid(gid);
        return Resp.ok(attGroupVOList);
    }
}
